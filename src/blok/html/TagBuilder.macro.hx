		...
		switch tag.kind {
			case TagVoid:
				builder.add(macro class {
					private static final $nameType = blok.PrimitiveView.getTypeForTag($v{name});
			...
			default:
				builder.add(macro class {
					...
					public static function $name(?props : $props & blok.html.HtmlEvents & {?key:blok.diffing.Key}, ...children : blok.Child) {
